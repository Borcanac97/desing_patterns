...
import "./App.css";
import { WoodenDoorFactory } from "./examples/Abstract_factory"
import { IronDoorFactory } from "./examples/Abstract_factory";
import { BurgerBuilder } from "./examples/Builder1";
import { WildDog } from "./examples/Adapter1";
import { WildDogAdapter } from "./examples/Adapter1";
import { AfricanLion } from "./examples/Adapter1";
import { Hunter } from "./examples/Adapter1";
import { User } from "./examples/Mediator";
import { ChatRoom } from "./examples/Mediator";
import { Designer } from "./examples/Composite1";
import { Developer } from "./examples/Composite1";
import { Subject } from "./examples/Observer1";
import { Observer } from "./examples/Observer1";
import { Organization } from "./examples/Composite1";
/* ABSTRACT FACTORY */
